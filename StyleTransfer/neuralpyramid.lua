...
content_images[3] = preproc(image.scale(content_images[3], 512, 'bilinear'))
content_images[4] = preproc(image.scale(content_images[4], 512, 'bilinear'))
...
if use_gpu == 1 then
  content_images[1] = content_images[1]:cuda()
  content_images[2] = content_images[2]:cuda()
  content_images[3] = content_images[3]:cuda()
  content_images[4] = content_images[4]:cuda()
